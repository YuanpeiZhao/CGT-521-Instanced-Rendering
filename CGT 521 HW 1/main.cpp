...
void display()
{
   ...
   glm::mat4 V = glm::lookAt(glm::vec3(5.0f, 0.0f, 3.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
int main (int argc, char **argv)
{
   ...
   int win = glutCreateWindow ("CGT 521 Lab 1");
